...
# Seattle, United States: Institute for Health Metrics and Evaluation (IHME), 2020.
# Available from http://ghdx.healthdata.org/gbd-results-tool.
suicide_raw <- read.csv("TooLarge/GBD 2019 suicide data.csv")
...
unpd_raw <- read.csv("Raw model input files/TooLarge/WPP2019_PopulationBySingleAgeSex_1950-2019.csv") ## FAILS UNTIL DOWNLOAD FROM:
...
pr_edu_um_wpro <- subset(pr_edu, grepl("Aggregate", pr_edu$edu_level) & 
                           country %in% china_proxy) ### THROWS WARNING
